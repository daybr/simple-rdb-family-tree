...
BEGIN
    ...
    MAKE_FAMILY_TREE(WOMAN_HID, ROOT_MATE_P_PID, 'N');
END;
/
...
SELECT LEV, CHON, SUBSTR(HID,1,4) AS HID, NAME, SEX,
        ...
        SUBSTR(MATE_P_PID,1,4) AS MATE_P_PID, SUBSTR(MATE_HID,1,4) AS MATE_HID,
        MATE_NAME, MATE_SEX, MATE_BIRTH, MATE_DEATH, SUBSTR(MATE_PID,1,4) AS MATE_PID
