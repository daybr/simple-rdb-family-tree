...
public class ParentsResultSetPrinter extends ResultSetPrinter {

	public ParentsResultSetPrinter(OutputStream output) {
		super(output);
	}

	public ParentsResultSetPrinter(Writer writer) {
		super(writer);
	}
